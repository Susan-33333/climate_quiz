    ...
    >
      ...
      <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl text-center max-w-md w-full space-y-6">
        ...
        {isImageLoaded && (
          <button
            onClick={onStart}
            className="h-[40px] inline-block font-bold text-[16px] rounded-[36px] border-2 px-4 py-2 text-center text-[#83482cff] border-[#E0E0E0] hover:shadow-[0_0_0_2px_rgba(112,71,45,0.4)] active:shadow-[0_0_0_2px_rgba(112,71,45,0.6)] transition-all duration-300"
          >
            開始穿越
          </button>
        )}
